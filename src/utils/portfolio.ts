import {AboutSectionType, ContactSectionType, ExperienceSectionType, HeroSectionType, NavbarSectionType,  ProjectsSectionType,  SkillsSectionType,  SocialSectionType} from '../types/section';
...
export const navbarSection: NavbarSectionType = {
  ...
  export const profileSection: HeroSectionType = {
    ...
    description:
     `I am a passionate Frontend web developer having an experience of developing web applications using
